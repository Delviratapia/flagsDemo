...
const DescriptionCountry: FC<Props> = ({ country }) => {
  ...
  return (
    <div className="w-full text-black dark:text-white sm:flex  sm:justify-around">
        <div className="w-[320px] h-[230px] sm:h-[400px] sm:w-[560px]">
      ...
      <div className="sm:grid-rows-5 sm:grid-cols-2 sm:grid mt-4 flex w-full flex-col gap-3 sm:w-auto sm:grid-flow-col">
